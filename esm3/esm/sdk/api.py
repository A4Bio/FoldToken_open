...
class ESMProtein:
    ...
    # secondary_structure: Union[str , None] = None
    # sasa = None
    # function_annotations = None
    # coordinates: Union[torch.Tensor , None] = None
    # Metrics
    plddt: Union[torch.Tensor , None] = None
    ptm: Union[torch.Tensor , None] = None
...
class ESMProteinTensor:
    sequence: Union[torch.Tensor , None] = None
    structure: Union[torch.Tensor , None] = None
    secondary_structure: Union[torch.Tensor , None] = None
    sasa: Union[torch.Tensor , None] = None
    function: Union[torch.Tensor , None] = None
    residue_annotations: Union[torch.Tensor , None] = None
    coordinates: Union[torch.Tensor , None] = None
    ...
    def device(self) -> Union[str , torch.device]:
        ...
        for track in tracks:
            current_track: Union[torch.Tensor , None] = getattr(self, track)
    ...
    def to(self, device: Union[str , torch.device , None]) -> ESMProteinTensor:
        if device is None:
            return self
...
@define
class ForwardOutput:
    logits: Union[ForwardTrackData , None] = None
    ...
    residue_annotation_logits: Union[torch.Tensor , None] = None
...
class ForwardAndSampleOutput(ForwardOutput):
    ...
    entropy: Union[ForwardTrackData , None] = None
    # Probability of sampled token
    prob: Union[ForwardTrackData , None] = None
    logprob: Union[ForwardTrackData , None] = None
    # Top probability at this position
    top_prob: Union[ForwardTrackData , None] = None
    topk_logprob: Union[ForwardTrackData , None] = None
    # Which tokens correspond to top probability
    topk_tokens: Union[ForwardTrackData , None] = None

    per_residue_embedding: Union[torch.Tensor , None] = None
    mean_embedding: Union[torch.Tensor , None] = None


ProteinType = TypeVar("ProteinType", bound=Union[ESMProteinTensor , ESMProtein])
