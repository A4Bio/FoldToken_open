...
def index_by_atom_name(
    atom37: ArrayOrTensor, atom_names: Union[str , list[str]], dim: int = -2
) -> ArrayOrTensor:
    squeeze = False
...
class AtomIndexer:
    ...
    def __getitem__(self, atom_names: Union[str , list[str]]) -> np.ndarray:
...
class ProteinChain:
    ...
    def __getitem__(self, idx: Union[int , list[int] , slice , np.ndarray]):
    ...
    @classmethod
    def from_blob(cls, input: Union[Path , str , io.BytesIO , bytes]):
    ...
    def align(
        self,
        target: ProteinChain,
        mobile_inds: Union[list[int].Tensor, np.ndarray, None] = None,
        target_inds: Union[list[int].Tensor, np.ndarray, None] = None,
    ...
    def from_atom37(
        cls,
        atom37_positions: Union[np.ndarray , torch.Tensor],
        *,
        id: Union[str , None] = None,
        sequence: Union[str , None] = None,
        chain_id: Union[str , None] = None,
        entity_id: Union[int , None] = None,
        residue_index: Union[np.ndarray , torch.Tensor , None] = None,
        insertion_code: Union[np.ndarray , None] = None,
        confidence: Union[np.ndarray , torch.Tensor , None] = None,
    ):
    ...
    def from_backbone_atom_coordinates(
        cls,
        backbone_atom_coordinates: Union[np.ndarray , torch.Tensor],
        **kwargs,
    ):
    ...
    def select_residue_indices(
        self, indices: list[Union[int , str]], ignore_x_mismatch: bool = False
    ) -> ProteinChain:
        numeric_indices = [
