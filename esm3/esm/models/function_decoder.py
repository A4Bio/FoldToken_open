...
class FunctionTokenDecoder(nn.Module):
    def __init__(self, config: Union[FunctionTokenDecoderConfig , None] = None):
    ...
    def decode(
        ...
        annotation_min_length: Union[int , None] = 5,
        annotation_gap_merge_max: Union[int , None] = 3,
    ):
...
def _merge_annotations(
    annotations: list[FunctionAnnotation],
    merge_gap_max: Union[int , None] = None,
