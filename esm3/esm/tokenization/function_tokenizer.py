...
class InterProQuantizedTokenizer(EsmTokenizerBase):
    ...
    def __init__(
        ...
        lsh_path: Union[str , None] = None,
        keyword_vocabulary_path: Union[str , None] = None,
        keyword_idf_path: Union[str , None] = None,
        interpro_entry_path: Union[str , None] = None,
        interpro2keywords_path: Union[str , None] = None,
    ):
    ...
    def _function_text_hash(
        ...
        keyword_mask: Union[np.ndarray , None] = None,
    ...
    def lookup_annotation_name(self, annotation: FunctionAnnotation) -> Union[str , None]:
