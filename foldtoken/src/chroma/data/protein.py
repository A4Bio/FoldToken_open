...
class Protein:
    ...
    def from_PDBID(
        ...
        from src.chroma.utility.fetchdb import RCSB_file_download
    ...
    def to_PDB(self, output_file: str, force: bool = False, mask_indices=None, seq=None) -> None:
        ...
        if output_file.lower().startswith("s3:"):
            ...
            self.sys.to_PDB(output_file, mask_indices=mask_indices, seq=seq)
    ...
    def to(self, file_path: str, force: bool = False, mask_indices=None, seq=None) -> None:
        ...
        if file_path.lower().endswith(".pdb"):
            self.to_PDB(file_path, force=force, mask_indices=mask_indices, seq=seq)
    ...
    def display(self, representations: list = []) -> None:
        ...
        """
        from src.chroma.utility.ngl import SystemTrajectory, view_gsystem
