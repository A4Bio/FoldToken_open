...
class MInterface_base(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # params_to_optimize = [param for name, param in self.model.named_parameters() if 'vq' in name]
        # params_to_optimize = [param for name, param in self.model.named_parameters()]
